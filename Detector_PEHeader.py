...
def get_peheader_features(path):
    ...
    peheader_features = vector.fit_transform(peheader_features)
    peheader_features = peheader_features.todense()
    peheader_features = numpy.asarray(peheader_features)
    peheader_features = peheader_features[0]
